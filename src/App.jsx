...
const TEACHERS = [
  ...
  "Castillo Soto Astrid",
  "Hernández Moreno Daniela",
  "Cossio Chavero Diana Claudia",
  "Serrano Hernández Miriam",
  "Salazar Ponce Rosalba",
  "Flores Guzmán Adriana Emilia",
  "Montebello Correa Mar",
  "Pérez Cortés Yulissa",
  "Xicotencatl Díaz Diana",
  "Luna Martínez Héctor Rubén",
  "Torres Soriano Verónica",
  "Alarcón Hernández Brayan Eduardo",
  "Guds Esperanza Anouska",
  "Sandoval Román Brenda Mariana",
